...
<head>
    ...
    <style>
        ...
        .button {
            ...
            /* Warna latar belakang tombol (misalnya, hijau) */
            color: white;
            /* Warna teks tombol (misalnya, putih) */
            border: none;
            /* Tanpa border */
            padding: 10px 20px;
            /* Padding */
        ...
        .button:hover {
            ...
            /* Warna latar belakang saat hover (misalnya, hijau tua) */
        }
...
<body>
    ...
    <p><a href="{{ route('buku.create')}}">
            <button class="button" 6>Tambah Buku</button>
        </a></p>
